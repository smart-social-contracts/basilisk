...
Configuration:
    Set environment variables or use defaults:
        BASILISK_TEST_CANISTER  — canister ID (default: gfs5q-6qaaa-aaaae-ag5nq-cai)
...
DEFAULT_CANISTER = "gfs5q-6qaaa-aaaae-ag5nq-cai"  # Dedicated Basilisk OS test canister
DEFAULT_NETWORK = "ic"
