...
2. Ensure that you have created and activated your virtual environment, and that you have done the following from within that virtual environment: installed Basilisk, installed the Basilisk dfx extension, and run `dfx deploy`:
...
4. Look for errors in each of the files in `~/.config/basilisk/[basilisk_version]/logs`
