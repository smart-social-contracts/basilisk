...
-   [threshold_ecdsa](https://github.com/demergent-labs/basilisk/tree/main/examples/motoko_examples/threshold_ecdsa)

```python
from basilisk import Async, blob, CallResult, match, Principal, update, Variant, void
