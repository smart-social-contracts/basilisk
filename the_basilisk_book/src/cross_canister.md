...
-   [cross_canister_calls](https://github.com/demergent-labs/basilisk/tree/main/examples/cross_canister_calls)
-   [cycles](https://github.com/demergent-labs/basilisk/tree/main/examples/cycles)
-   [ethereum_json_rpc](https://github.com/demergent-labs/basilisk/tree/main/examples/ethereum_json_rpc)
-   [func_types](https://github.com/demergent-labs/basilisk/tree/main/examples/func_types)
...
-   [ledger_canister](https://github.com/demergent-labs/basilisk/tree/main/examples/ledger_canister)
-   [management_canister](https://github.com/demergent-labs/basilisk/tree/main/examples/management_canister)
-   [outgoing_http_requests](https://github.com/demergent-labs/basilisk/tree/main/examples/outgoing_http_requests)
-   [threshold_ecdsa](https://github.com/demergent-labs/basilisk/tree/main/examples/threshold_ecdsa)
...
```python
from basilisk import ic, nat64, Principal, StableBTreeMap, update
...
```python
from basilisk import nat64, Principal, Service, service_update
...
The IC guarantees that cross-canister calls will return. This means that, generally speaking, you will always receive a `CallResult`. Basilisk does not raise on cross-canister calls. Wrapping your cross-canister call in a `try...except` most likely won't do anything useful.
...
```python
from basilisk import ic, nat64, Principal, StableBTreeMap, update, Variant
