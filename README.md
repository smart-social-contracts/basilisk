...
- [icp-cli](https://cli.internetcomputer.org/0.2/guides/installation/) (`curl --proto '=https' --tlsv1.2 -LsSf https://github.com/dfinity/icp-cli/releases/latest/download/icp-cli-installer.sh | sh`)
- Python 3.10+
